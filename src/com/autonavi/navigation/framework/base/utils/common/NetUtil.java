...
public class NetUtil {
    ...
    /**
     * Set mobile data connectivity on/off. API level 9+ only (Android 2.3+).
     * This method will need "android.permission.CHANGE_NETWORK_STATE"
     * permission.
     * 
     * @param context Application Context
    ...
    public static boolean changeMobileDataState(Context context, boolean dataEnabled) {
        if (Build.VERSION.SDK_INT < 9) {
            throw new UnsupportedOperationException(
                    "Unsupported SDK version. This operation is only available on SDK 9 or above.");
        }
        ...
        try {
            ...
            Method setMobileDataEnabled = connectivityManagerClass.getDeclaredMethod(
    ...
    /**
     * Check state of mobile data connectivity (on/off). Please note that this
     * method *does not* guarantee that a connection is available, it only
    ...
    public static boolean checkMobileDataState(Context context) throws Exception {
        try {
            ...
            Class connectivityManagerClass = Class
                    .forName(connectivityManager.getClass().getName());
            Method getMobileDataEnabled = connectivityManagerClass

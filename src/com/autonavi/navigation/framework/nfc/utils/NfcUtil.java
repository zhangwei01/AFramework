...
package com.autonavi.navigation.framework.nfc.utils;
...
public class NfcUtil {
    ...
    public static String parseText(NdefRecord record) {
        ...
        try {
            ...
            String text = new String(payload, languageCodeLength + 1, payload.length
    ...
    private static Uri parseAbsolute(NdefRecord record) {
        byte[] payload = record.getPayload();
